...
import KeralaMapsAnnotated from '../../images/archive/projects/necessary-reunions/kerala-coast-annotated-map.png';
import KeralaAnnotationExample from '../../images/archive/projects/necessary-reunions/kerala-map-annotation-example.jpg';
import RechartedLogo from '../../images/archive/projects/necessary-reunions/recharted-interface-logo.png';
...
As researcher on this interdisciplinary team, I contributed to creating **re:Charted**, a web-based platform that combines emerging techniques in computer vision, handwritten text recognition, and georeferencing to unlock new perspectives on 17th and 18th-century Indian Ocean trade networks.
...
<Image
  ...
  alt="Detail of a 17th-century Dutch East India Company (VOC) map of Kerala showing place name annotation examples from the Leupe archival collection — Necessary Reunions digital humanities platform"
  className="mt-10"
/>
...
<Image
  ...
  alt="AI-annotated historical VOC map of the Kerala coastline showing automated computer vision detection of visual elements (red) and handwritten text recognition (HTR) segments (blue) for VOC gazetteer research"
  className="mt-10"
/>
<div className="caption">
...
<Image
  src={RechartedLogo}
  alt="re:Charted web platform logo — digital humanities interface for georeferencing and annotating 17th-century VOC archival maps for early modern Kerala historical research"
  className="mt-10"
/>
<div className="caption">
