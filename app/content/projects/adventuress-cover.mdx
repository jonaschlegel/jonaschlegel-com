...
import AdventuressCoverDesign from '../../images/archive/projects/adventuress-cover-design.jpg';
import AdventuressCoverConcept from '../../images/archive/projects/adventuress-cover-concept.jpg';
...
<Image
  ...
  alt="Initial concept sketching and reference research for the Adventuress Archaeology Journal cover design — celebrating women in archaeology including Dorothy Garrod and contemporary field leaders"
  className="mt-10"
/>
...
<Image
  ...
  alt="Completed Adventuress Archaeology Journal cover illustration featuring three female archaeologists representing past, present, and future — scientific illustration by Jona Schlegel"
  className="mt-10"
/>
<div className="caption">
