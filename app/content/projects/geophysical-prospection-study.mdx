...
import SiteOverview from '../../images/archive/projects/geophysical-study/archaeological-site-overview.webp';
import ProspectionAreas from '../../images/archive/projects/geophysical-study/prospection-areas.webp';
import RadarMagneticResults from '../../images/archive/projects/geophysical-study/radar-magnetic-results-historical-map-irrigation-system.png';
import RadarGrave3D from '../../images/archive/projects/geophysical-study/radar-results-grave-situtation-3d.png';
import RadarPlantaTower from '../../images/archive/projects/geophysical-study/radar-results-plantatower.png';
...
<Image
  src={SiteOverview}
  alt="Aerial context photograph of the Müstair Carolingian monastery UNESCO World Heritage Site (c. 780 AD) showing medieval buildings within their Alpine landscape, Switzerland"
  className="mt-10"
/>
...
<Image
  ...
  alt="Survey area plan showing systematic magnetometry and ground-penetrating radar (GPR) coverage across the Müstair monastery UNESCO heritage site — non-invasive geophysical prospection strategy"
  className="mt-10"
/>
<div className="caption">
...
<Image
  ...
  alt="Combined GPR and magnetometry geophysical survey results overlaid on historical maps of the Müstair monastery, revealing buried Carolingian-period archaeological structures"
  className="mt-10"
/>
<div className="caption">
...
<Image
  src={RadarGrave3D}
  alt="3D ground-penetrating radar (GPR) slice visualisation showing underground burial contexts and structural relationships at the Müstair UNESCO Carolingian monastery, Switzerland"
  className="mt-10"
/>
<div className="caption">
...
<Image
  ...
  alt="Detailed GPR radar results revealing subsurface foundations and the complete structural layout of the Planta Tower complex at the Müstair UNESCO World Heritage Site, Switzerland"
  className="mt-10"
/>
<div className="caption">
