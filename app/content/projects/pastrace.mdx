...
import PasTraceLogo from '../../images/archive/projects/pastrace/pastrace-logo-symbol.png';
import PasTraceWordmark from '../../images/archive/projects/pastrace/pastrace-full-logo.png';
import PasTraceTagline from '../../images/archive/projects/pastrace/pastrace-with-tagline.png';
...
<Image
  src={PasTraceLogo}
  alt="PasTrace archaeology brand identity logo symbol showing geometric diamond design in red"
  className="mt-10"
/>
...
<Image
  ...
  alt="Complete PasTrace wordmark for 3D cultural heritage photogrammetry company — horizontal logo layout with red geometric diamond symbol and company name"
  className="mt-10"
/>
<div className="caption">
