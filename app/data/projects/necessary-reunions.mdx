...
**Duration**: March–December 2025 (software published February 2026)
...
**Technologies**: Next.js 16, React 19, Leaflet, OpenSeadragon, Allmaps, AnnoRepo, Tailwind CSS, IIIF, computer vision, HTR (Loghi toolkit), georeferencing
**Collaborators**: Dr. Manjusha Kuruppath (Huygens Institute), Leon van Wissen (University of Amsterdam)
**Live platform**: [necessaryreunions.org](https://necessaryreunions.org/)
**Software (Zenodo)**: [doi.org/10.5281/zenodo.18787727](https://doi.org/10.5281/zenodo.18787727)
