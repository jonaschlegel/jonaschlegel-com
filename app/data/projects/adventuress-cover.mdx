...
<Image
  ...
  alt="Concept sketching and research notes for the archaeology cover art design"
  className="mt-10"
/>
...
<Image
  ...
  alt="Completed archaeology cover art showing digital painting of three female archaeologists across different time periods"
  className="mt-10"
/>
<div className="caption">
