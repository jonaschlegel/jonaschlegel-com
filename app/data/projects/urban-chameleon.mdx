...
<Image
  src={UrbanChameleon1}
  alt="AGIL agile methodology diagram for the Urban Chameleon digital heritage web platform — documenting graffiti as intangible cultural heritage along Vienna’s Danube Canal for Project INDIGO"
  className="mt-10"
/>
...
<Image
  src={UrbanChameleon2}
  alt="Systematic heritage documentation methodology combining structured photography and community engagement for the Urban Chameleon graffiti research platform, Vienna Danube Canal"
  className="mt-10"
/>
<div className="caption">
...
<Image
  src={UrbanChameleon3}
  alt="Urban Chameleon web platform interface — fullstack archaeology web development for heritage documentation and public access to Vienna Danube Canal graffiti under Project INDIGO"
  className="mt-10"
/>
<div className="caption">
